...
type API interface {
	...
	UpdateInstallProgress(ctx context.Context, c *common.Cluster, progress string, db *gorm.DB) *common.ApiErrorResponse
}
...
func (m *Manager) UpdateInstallProgress(ctx context.Context, c *common.Cluster, progress string, db *gorm.DB) *common.ApiErrorResponse {
	eventSeverity := models.EventSeverityInfo
