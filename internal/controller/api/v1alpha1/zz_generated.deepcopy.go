...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MacInterfaceMapItems) DeepCopyInto(out *MacInterfaceMapItems) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MacInterfaceMapItems.
func (in *MacInterfaceMapItems) DeepCopy() *MacInterfaceMapItems {
	if in == nil {
		return nil
	}
	out := new(MacInterfaceMapItems)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NMStateConfigSpec) DeepCopyInto(out *NMStateConfigSpec) {
	*out = *in
	if in.MacInterfaceMap != nil {
		in, out := &in.MacInterfaceMap, &out.MacInterfaceMap
		*out = make([]*MacInterfaceMapItems, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MacInterfaceMapItems)
